...
class Pharmacy_Billing(object):
    ...
    def __init__(self, root):
        ...
        medicol_advance_lbl = Label(F2, font=("Calibri", 15, "bold"), fg=lbl_color, bg=bg_color, text="Jeenal")
        ...
        # This function for Niaspan
        tikitiki_lbl = Label(F2, font=("Calibre", 15, "bold"), fg=lbl_color, bg=bg_color, text="Niaspan")
    ...
    def welcome_customer(self):
        ...
        self.txt.insert(END, "Welcome To Group 7's Pharmacy Store\n")
    ...
    def billing_section(self):
        ...
        if self.tiki_tiki_star.get() != 0:
            self.txt.insert(END, f"\nNiaspan {self.tiki_tiki_star.get()} {self.tiki_tiki_star.get() * 150}")
